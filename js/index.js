window.onload = function () {
  ...
  var data = {
    ...
    definitions: [
      {
        index: 0,
        text: 'To prepare for a future event or situation',
      },
      {
        index: 1,
        text: 'To succeed in doing something difficult or tricky',
      },
      {
        index: 2,
        text: 'To assemble or connect the parts of something.',
      },
      {
        index: 3,
      ...
      {
        index: 4,
        text: 'To avoid discussing a certain subject or topic.',
      },
      {
        index: 5,
        text: 'To transform',
